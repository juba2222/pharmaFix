...
- واجهة فواتير مشتريات ذكية (New Purchase Invoice) تدعم البحث المزدوج (محلي/سحابي) وتوليد دفعات المخزون آلياً.
- معالجة العمليات المالية والمخزنية كعمليات ذرية (Atomic Transactions) لضمان سلامة البيانات.
...
- [ ] **نظام المرتجعات:** تفعيل نظام المرتجعات (Returns) للمبيعات والمشتريات.

...
mixin _$PurchaseInvoiceState {
 ...
 List<Map<String, dynamic>> get cartItems; double get totalAmount; double get paidAmount; bool get isSaving; String? get error; bool get success;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(cartItems),totalAmount,paidAmount,isSaving,error,success);

@override
String toString() {
  return 'PurchaseInvoiceState(cartItems: $cartItems, totalAmount: $totalAmount, paidAmount: $paidAmount, isSaving: $isSaving, error: $error, success: $success)';
}
...
@useResult
$Res call({
 List<Map<String, dynamic>> cartItems, double totalAmount, double paidAmount, bool isSaving, String? error, bool success
});
...
/// Create a copy of PurchaseInvoiceState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cartItems = null,Object? totalAmount = null,Object? paidAmount = null,Object? isSaving = null,Object? error = freezed,Object? success = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Map<String, dynamic>> cartItems,  double totalAmount,  double paidAmount,  bool isSaving,  String? error,  bool success)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PurchaseInvoiceState() when $default != null:
return $default(_that.cartItems,_that.totalAmount,_that.paidAmount,_that.isSaving,_that.error,_that.success);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Map<String, dynamic>> cartItems,  double totalAmount,  double paidAmount,  bool isSaving,  String? error,  bool success)  $default,) {final _that = this;
switch (_that) {
case _PurchaseInvoiceState():
return $default(_that.cartItems,_that.totalAmount,_that.paidAmount,_that.isSaving,_that.error,_that.success);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Map<String, dynamic>> cartItems,  double totalAmount,  double paidAmount,  bool isSaving,  String? error,  bool success)?  $default,) {final _that = this;
switch (_that) {
case _PurchaseInvoiceState() when $default != null:
return $default(_that.cartItems,_that.totalAmount,_that.paidAmount,_that.isSaving,_that.error,_that.success);case _:
  return null;
...
class _PurchaseInvoiceState implements PurchaseInvoiceState {
  const _PurchaseInvoiceState({final  List<Map<String, dynamic>> cartItems = const [], this.totalAmount = 0.0, this.paidAmount = 0.0, this.isSaving = false, this.error, this.success = false}): _cartItems = cartItems;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_cartItems),totalAmount,paidAmount,isSaving,error,success);
...
/// Create a copy of PurchaseInvoiceState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cartItems = null,Object? totalAmount = null,Object? paidAmount = null,Object? isSaving = null,Object? error = freezed,Object? success = null,}) {

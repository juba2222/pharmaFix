...
mixin _$Manufacturer {
 ...
 String get id;@JsonKey(name: 'pharmacy_id') String get pharmacyId; String get name;@JsonKey(name: 'updated_at') DateTime? get updatedAt;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,pharmacyId,name,updatedAt,createdAt);

@override
String toString() {
  return 'Manufacturer(id: $id, pharmacyId: $pharmacyId, name: $name, updatedAt: $updatedAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'pharmacy_id') String pharmacyId, String name,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of Manufacturer
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? pharmacyId = null,Object? name = null,Object? updatedAt = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'pharmacy_id')  String pharmacyId,  String name, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Manufacturer() when $default != null:
return $default(_that.id,_that.pharmacyId,_that.name,_that.updatedAt,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'pharmacy_id')  String pharmacyId,  String name, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Manufacturer():
return $default(_that.id,_that.pharmacyId,_that.name,_that.updatedAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'pharmacy_id')  String pharmacyId,  String name, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Manufacturer() when $default != null:
return $default(_that.id,_that.pharmacyId,_that.name,_that.updatedAt,_that.createdAt);case _:
  return null;
...
class _Manufacturer implements Manufacturer {
  const _Manufacturer({required this.id, @JsonKey(name: 'pharmacy_id') required this.pharmacyId, required this.name, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'created_at') this.createdAt});
...
/// Create a copy of Manufacturer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? pharmacyId = null,Object? name = null,Object? updatedAt = freezed,Object? createdAt = freezed,}) {
